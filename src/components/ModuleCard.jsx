  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", display: "flex", alignItems: "flex-start", justifyContent: "space-between", width: "100%" }}>
        ...
        >
          <Icon size={24} color={hov ? accent : (C.text || "#fff")} strokeWidth={1.5} style={{ transition: "color .25s" }} />
        </span>
        {(!active || tag) && (
          <span
            style={{
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", gap: 4, width: "100%" }}>
        <p style={{ fontSize: 18, fontWeight: 700, color: C.text || "#fff", margin: 0, lineHeight: "24px" }}>{title}</p>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <p style={{ fontSize: 13, fontWeight: 400, color: C.sub || "#c4c7c8", margin: 0 }}>{subtitle}</p>
          <span
            style={{
              fontSize: 12,
              fontWeight: 600,
