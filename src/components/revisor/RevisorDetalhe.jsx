...
export default function RevisorDetalhe({ reviewId, onBack }) {
  const id = reviewId;
  ...
  if (!review) return <p style={{ color: "#888" }}>Mão não encontrada.</p>;
  ...
  return (
    <div>
      <div style={{ marginBottom: 16 }}>
        <h2 style={{ fontSize: 18, margin: 0 }}>{review.title || "Mão sem título"}</h2>
        <div style={S.tagsRow}>
          {review.tags.map((t) => (
      ...
      {(review.free_text || review.hand_history) && (
        <section style={S.section}>
          <h3 style={S.sectionTitle}>Contexto</h3>
      ...
      {imgUrls.length > 0 && (
        <section style={S.section}>
          <h3 style={S.sectionTitle}>Prints</h3>
          <div style={S.imgGrid}>
            {imgUrls.map((u, i) => u && (
      ...
      <section style={S.section}>
        <div style={S.sectionHeader}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <h3 style={S.sectionTitle}>Perguntas guiadas</h3>
          </div>
      ...
      <section style={S.section}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
          ...
          <h3 style={S.sectionTitle}>Auto-avaliação por street</h3>
        </div>
      ...
      <section style={S.section}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
          ...
          <h3 style={S.sectionTitle}>Registro de aprendizado</h3>
        </div>
      ...
      <section style={S.section}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
          ...
          <h3 style={S.sectionTitle}>Sugestão de drill</h3>
        </div>
